program seg
  ...
  flux_filenames(1) = '/scratch/cimes/dd7201/DA_increments/DiffDA/M_prod_inc/ocean_daily.20110101-20111231.hflso.nc'
  flux_filenames(2) = '/scratch/cimes/dd7201/DA_increments/DiffDA/M_prod_inc/ocean_daily.20110101-20111231.hfsso.nc'
  flux_filenames(3) = '/scratch/cimes/dd7201/DA_increments/DiffDA/M_prod_inc/ocean_daily.20110101-20111231.rlntds.nc'
  flux_filenames(4) = '/scratch/cimes/dd7201/DA_increments/DiffDA/M_prod_inc/ocean_daily.20110101-20111231.rsntds.nc'
  flux_filenames(5) = '/scratch/cimes/dd7201/DA_increments/DiffDA/M_prod_inc/ocean_daily.20110101-20111231.taux.nc'
  flux_filenames(6) = '/scratch/cimes/dd7201/DA_increments/DiffDA/M_prod_inc/ocean_daily.20110101-20111231.tauy.nc'
  tracer_filenames(1) = '/scratch/cimes/dd7201/DA_increments/DiffDA/M_prod_inc/ocean_z_daily.20110101-20111231.thetao.nc'
  tracer_filenames(2) = '/scratch/cimes/dd7201/DA_increments/DiffDA/M_prod_inc/ocean_z_daily.20110101-20111231.so.nc'
  current_filenames(1) = '/scratch/cimes/dd7201/DA_increments/DiffDA/M_prod_inc/ocean_z_daily.20110101-20111231.uo.nc'
  current_filenames(2) = '/scratch/cimes/dd7201/DA_increments/DiffDA/M_prod_inc/ocean_z_daily.20110101-20111231.vo.nc'
